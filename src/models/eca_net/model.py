...
def eca_resnet50(k_size=[3, 3, 3, 3], n_classes=1000, pretrained=False):
    ...
    Args:
        ...
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(ECABottleneck, [3, 4, 6, 3], num_classes=n_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
if __name__ == '__main__':
    model = eca_resnet50(n_classes=1000)
